...
public class CookingStandScreen extends AbstractContainerScreen<CookingStandMenu> {
	private final static HashMap<String, Object> guistate = CookingStandMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public CookingStandScreen(CookingStandMenu container, Inventory inventory, Component text) {
	...
	private static final ResourceLocation texture = new ResourceLocation("epicraft:textures/screens/cooking_stand.png");
