...
public class MetalWorkbenchScreen extends AbstractContainerScreen<MetalWorkbenchMenu> {
	private final static HashMap<String, Object> guistate = MetalWorkbenchMenu.guistate;
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MetalWorkbenchScreen(MetalWorkbenchMenu container, Inventory inventory, Component text) {
