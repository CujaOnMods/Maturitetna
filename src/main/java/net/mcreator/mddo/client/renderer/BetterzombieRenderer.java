...
public class BetterzombieRenderer extends HumanoidMobRenderer<BetterzombieEntity, HumanoidModel<BetterzombieEntity>> {
	public BetterzombieRenderer(EntityRendererProvider.Context context) {
