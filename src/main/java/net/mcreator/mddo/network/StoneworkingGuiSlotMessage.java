...
public class StoneworkingGuiSlotMessage {
	private final int slotID, x, y, z, changeType, meta;

	public StoneworkingGuiSlotMessage(int slotID, int x, int y, int z, int changeType, int meta) {
		this.slotID = slotID;
		this.x = x;
		this.y = y;
		this.z = z;
	...
	public StoneworkingGuiSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(StoneworkingGuiSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(StoneworkingGuiSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void handleSlotAction(Player entity, int slot, int changeType, int meta, int x, int y, int z) {
		...
		HashMap guistate = StoneworkingGuiMenu.guistate;
