...
public class RedstoneWorkBenchGuiSlotMessage {
	...
	public RedstoneWorkBenchGuiSlotMessage(FriendlyByteBuf buffer) {
	...
	public static void buffer(RedstoneWorkBenchGuiSlotMessage message, FriendlyByteBuf buffer) {
	...
	public static void handler(RedstoneWorkBenchGuiSlotMessage message, Supplier<NetworkEvent.Context> contextSupplier) {
	...
	public static void registerMessage(FMLCommonSetupEvent event) {
		EpicraftMod.addNetworkMessage(RedstoneWorkBenchGuiSlotMessage.class, RedstoneWorkBenchGuiSlotMessage::buffer, RedstoneWorkBenchGuiSlotMessage::new, RedstoneWorkBenchGuiSlotMessage::handler);
	}
}
