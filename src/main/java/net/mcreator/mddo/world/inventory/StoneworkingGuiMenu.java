...
public class StoneworkingGuiMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public StoneworkingGuiMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		...
		this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 37, 36) {
		...
		this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 54, 36) {
		...
		this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 20, 53) {
		...
		this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 7, 37, 53) {
		...
		this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 8, 54, 53) {
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof StoneworkingGuiMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			StoneGuiOpenProcedure.execute(world, entity);
		}
	}
}
