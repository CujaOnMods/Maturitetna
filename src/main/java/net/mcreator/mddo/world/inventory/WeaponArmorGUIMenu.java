...
import net.mcreator.mddo.procedures.WeaponarmorOpenProcedure;
import net.mcreator.mddo.network.WeaponArmorGUISlotMessage;
...
public class WeaponArmorGUIMenu extends AbstractContainerMenu implements Supplier<Map<Integer, Slot>> {
	...
	public WeaponArmorGUIMenu(int id, Inventory inv, FriendlyByteBuf extraData) {
		super(EpicraftModMenus.WEAPON_ARMOR_GUI.get(), id);
	...
	private void slotChanged(int slotid, int ctype, int meta) {
		if (this.world != null && this.world.isClientSide()) {
			EpicraftMod.PACKET_HANDLER.sendToServer(new WeaponArmorGUISlotMessage(slotid, x, y, z, ctype, meta));
			WeaponArmorGUISlotMessage.handleSlotAction(entity, slotid, ctype, meta, x, y, z);
		}
	}
	...
	public static void onPlayerTick(TickEvent.PlayerTickEvent event) {
		...
		if (event.phase == TickEvent.Phase.END && entity.containerMenu instanceof WeaponArmorGUIMenu) {
			Level world = entity.level();
			double x = entity.getX();
			double y = entity.getY();
			double z = entity.getZ();
			WeaponarmorOpenProcedure.execute(world, entity);
		}
	}
}
