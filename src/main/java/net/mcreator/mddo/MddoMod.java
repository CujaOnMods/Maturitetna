...
@Mod("mddo")
public class MddoMod {
	public static final Logger LOGGER = LogManager.getLogger(MddoMod.class);
	public static final String MODID = "mddo";
