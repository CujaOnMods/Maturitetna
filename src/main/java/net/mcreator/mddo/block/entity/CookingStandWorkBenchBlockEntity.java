...
public class CookingStandWorkBenchBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	...
	public Component getDefaultName() {
		return Component.literal("cooking_stand_work_bench");
	}
	...
	public AbstractContainerMenu createMenu(int id, Inventory inventory) {
		return new CookingStandMenu(id, inventory, new FriendlyByteBuf(Unpooled.buffer()).writeBlockPos(this.worldPosition));
	}
