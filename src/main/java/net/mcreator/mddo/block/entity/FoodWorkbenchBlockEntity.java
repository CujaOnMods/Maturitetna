...
public class FoodWorkbenchBlockEntity extends RandomizableContainerBlockEntity implements WorldlyContainer {
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(11, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public FoodWorkbenchBlockEntity(BlockPos position, BlockState state) {
		super(EpicraftModBlockEntities.FOOD_WORKBENCH.get(), position, state);
	}
	...
	public Component getDefaultName() {
		return Component.literal("food_workbench");
	}
