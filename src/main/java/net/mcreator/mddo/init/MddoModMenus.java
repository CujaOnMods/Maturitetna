...
public class MddoModMenus {
	...
	public static final RegistryObject<MenuType<FoodWOrkBenchGuiMenu>> FOOD_W_ORK_BENCH_GUI = REGISTRY.register("food_w_ork_bench_gui", () -> IForgeMenuType.create(FoodWOrkBenchGuiMenu::new));
}
